...
def vild(image_path, category_name_string, params, plot_on=True, prompt_swaps=[]):
  ...
  # print('a', detection_boxes.shape)
  # print('b', detection_masks[0])
  # print('c', rescaled_detection_boxes)
  ...
  for anno_idx in indices[0:int(rescaled_detection_boxes.shape[0])]:
    ...
    # plt.imshow(segmentations[anno_idx])
    # # plt.axis("off")
    # plt.title(f"{found_object}")
    # plt.show()
